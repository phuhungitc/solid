...
(function($) {
	$(document).ready(function(){
		...
		$(".input-text-gia").bind('input', function() {
			if($("input[name=lan]:checked").val()!= null && $("input[name=p]:checked").val()!=null && $("input[name=sale]:checked").val()!=null && $(".input-text-gia").val()!=null){
				$a = eval($("input[name=lan]:checked").val() + "*" + $("input[name=p]:checked").val() + "*" +
		 		$(".input-text-gia").val() + "*" + $("input[name=sale]:checked").val() );
				$(".tien-tietkiem").text(formatNumber($a, '.', ',')+' VNĐ');
				$(".tong-truoc-tietkiem").css('display','block');
				$(".tien-tietkiem-nam").text(formatNumber(eval($a + "* 12"), '.', ',')+ " VNĐ");
			}
	  });
	...
	$("input[name=lan]").change(function(){
		if($("input[name=lan]:checked").val()!= null && $("input[name=p]:checked").val()!=null && $("input[name=sale]:checked").val()!=null && $(".input-text-gia").val()!=null){
			$a = eval($("input[name=lan]:checked").val() + "*" + $("input[name=p]:checked").val() + "*" +
			$(".input-text-gia").val() + "*" + $("input[name=sale]:checked").val() );
			$(".tien-tietkiem").text(formatNumber($a, '.', ',')+' VNĐ');
	 ...
	 $("#custom_logo_transparent img").attr('src','http://legourmets.123websitedemo.com/wp-content/uploads/2018/03/logo@2x_white.png');
	  $("#custom_logo_transparent img").attr('style','width:165px;height:auto;');
	$("#custom_logo img").attr('src','http://legourmets.123websitedemo.com/wp-content/uploads/2018/03/logo@2x_white.png');
 });
